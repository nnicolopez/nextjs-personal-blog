...
const es = {
  ...
  appearance: "Apariencia", appearanceHint: "Colores del dashboard y del sitio. Noche o día se cambia con el botón de arriba.",
...
const en: Dictionary = {
  ...
  appearance: "Appearance", appearanceHint: "Colors for the dashboard and the site. Switch night or day with the button above.",
